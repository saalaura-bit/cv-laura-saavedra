# Hi, I'm Laura Saavedra

## QA Senior Tech Lead | Business Analysis | Scrum Master
...
* **QA & Testing:** Playwright, Selenium, Cypress, Appium, Postman, JMeter, k6, Shift-Left Testing, Risk-Based Validation, UAT
* **Business Analysis:** BABOK, BRD, SRS, URS, FRD, RTM, BPMN, ERD, DFD, SWOT, Cost-Benefit Analysis, Change Control (CCB)
* **Agile:** Scrum, SAFe, Kanban, Sprint Planning, Backlog Refinement, Story Points, Retrospectives
* **CI/CD & DevOps:** Jenkins, GitHub Actions, Docker, Azure DevOps, Quality Gates
* **Technical:** SQL, Oracle DB, Python, REST APIs, Linux
* **Certifications:** ISTQB CTFL v4.0, Certified Mentor Trainer (PMBOK), Enterprise AI Solution

---

### Featured Work

This repository contains my professional CV in two formats:
